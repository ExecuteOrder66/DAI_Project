...
public class ServiceThread implements Runnable {
	...
	public void run() {
		try (Socket socket = this.clientSocket) {
			...
			try {	//try para capturar excepciones y poder notificar al cliente de los errores
				...
				//?
				HTTPResponse response = new HTTPResponse();
				String error400 = "<html><head></head><body>ERROR 400: bad request ParseException</body></html>";
				response.setStatus(HTTPResponseStatus.forCode(400));
				response.setContent(error400);
